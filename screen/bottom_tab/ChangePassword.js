import { StyleSheet, Text, View, Image, TextInput,ToastAndroid, Pressable, TouchableOpacity, ScrollView, Dimensions } from 'react-native'
...
const ChangePassword = ({ navigation }) => {
  ...
  const onChangePassword = async () => {
    try {
const response = await AxiosInstance().put('user/api/register',{})
    } catch (error){
